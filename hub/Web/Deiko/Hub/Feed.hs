...
atom_xml =
  "/home/yoeight/code/python/pubsubhubbub/hub/feed_diff_testdata/atom_valid.xml"

main = do content <- readFile atom_xml
          traverse_ print (elementFeed =<< parseXMLDoc content)
